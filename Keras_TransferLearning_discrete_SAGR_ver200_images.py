...
eda.rescaling(list_valence,1,7)
eda.rescaling(list_arousal,1,7)
...
if dir_train == dir_gaped:
    ...
    Name_testset,Valence_mean_testset,Arousal_mean_testset = list_name,list_valence,list_arousal
else:
...
#        os.makedirs(test_crossset_data_dir+"null")
    ...
    for i in range(0,len(Name_trainset_trainsubset)):
        ...
        if (float(Label_trainset_trainsubset[i])<0):
            copy(dir_train + subdir_trainsubset+"/"+Name_trainset_trainsubset[i]+".jpg", train_data_dir+"negative")
        elif (float(Label_trainset_trainsubset[i])>=0):
            copy(dir_train + subdir_trainsubset+"/"+Name_trainset_trainsubset[i]+".jpg", train_data_dir+"positive")
#        elif (float(Label_trainset_trainsubset[i])==0):
#            copy(dir_train + subdir_trainsubset+"/"+Name_trainset_trainsubset[i]+".jpeg", train_data_dir+"null")
    ...
    for i in range(0,len(Name_trainset_validationsubset)):
        ...
        if (float(Label_trainset_validationsubset[i])<0):
            copy(dir_train + subdir_trainsubset+"/"+Name_trainset_validationsubset[i]+".jpg", validation_data_dir+"negative")
        elif (float(Label_trainset_validationsubset[i])>=0):
            copy(dir_train + subdir_trainsubset+"/"+Name_trainset_validationsubset[i]+".jpg", validation_data_dir+"positive")
#        elif (float(Label_trainset_validationsubset[i])==0):
#            copy(dir_train + subdir_trainsubset+"/"+Name_trainset_validationsubset[i]+".jpeg", validation_data_dir+"null")
    ...
    for i in range(0,len(Name_trainset_testsubset)):
        ...
        if (float(Label_trainset_testsubset[i])<0):
            copy(dir_train + subdir_testsubset+"/"+Name_trainset_testsubset[i]+".jpg", test_sameset_data_dir+"negative")
        elif (float(Label_trainset_testsubset[i])>=0):
            copy(dir_train + subdir_testsubset+"/"+Name_trainset_testsubset[i]+".jpg", test_sameset_data_dir+"positive")
#        elif (float(Label_trainset_testsubset[i])==0):
#            copy(dir_train + subdir_testsubset+"/"+Name_trainset_testsubset[i]+".jpeg", test_sameset_data_dir+"null")
    ...
    for i in range(0,len(Name_testset)):
        ...
        if (float(Label_testset[i])<0):
            copy(dir_test + subdir_testcrossset+"/"+Name_testset[i]+".jpg", test_crossset_data_dir+"negative")
        elif (float(Label_testset[i])>=0):
            copy(dir_test + subdir_testcrossset+"/"+Name_testset[i]+".jpg", test_crossset_data_dir+"positive")
#        elif (float(Label_testset[i])==0):
...
#L = [37.585421446244105,59.681093461964288,53.986332492567676,57.403189100002649,58.314350919462818,43.735763084372522,43.280182164459404,51.708428110239993,42.596810798167098,58.31435077011178]
#L900 = [60.227272185412318,61.363635821775951,59.68109336692271,59.681093244726405,59.681093319401924,59.681093407654814,59.681093421232191,59.681093407654814]